...
# txid4479[ORGN] = Poaceae

#qiime rescript get-ncbi-data \
#    --p-query '(txid4479[ORGN] AND (ITS OR Internal Transcribed Spacer) NOT environmental sample[Title] NOT environmental samples[Title] NOT environmental[Title] NOT uncultured[Title] NOT unclassified[Title] NOT unidentified[Title] NOT unverified[Title])' \
#    --o-sequences taxonomy/RefTaxo.qza \
 #   --o-taxonomy taxonomy/DataSeq.qza

#     --p-query '(txid4479[ORGN] AND (ITS OR Internal Transcribed Spacer) NOT environmental sample[Title] NOT environmental samples[Title] NOT environmental[Title] NOT uncultured[Title] NOT unclassified[Title] NOT unidentified[Title] NOT unverified[Title] AND (country Europe OR country Asia OR country Africa OR France OR Spain OR Germany OR Italy OR Belgium OR Greece OR Iceland OR Lebanon OR Liechtenstein OR Luxembourg OR Russia OR Slovakia OR Slovenia OR Sweden OR Switzerland OR Turkmenistan OR Uzbekistan)' \
...
# taxonomy_NCBI_only_poaceae_good_country
#     --p-query '(txid4479[ORGN] AND (ITS OR country Internal Transcribed Spacer) NOT environmental sample[Title] NOT environmental samples[Title] NOT environmental[Title] NOT uncultured[Title] NOT unclassified[Title] NOT unidentified[Title] NOT unverified[Title] AND (country France OR country Spain OR country Germany OR country Italy OR country Belgium OR country Greece OR country Iceland OR country Lebanon OR country Liechtenstein OR country Luxembourg OR country Russia OR country Slovakia OR country Slovenia OR country Sweden OR country Switzerland OR country Turkmenistan OR country Uzbekistan OR country Netherlands OR country Poland OR country Czech republic OR country Austria OR country Croatia OR country Albania OR country Macedonia OR country Serbia OR country Romania OR country Moldavia OR country Ukraine OR country Belarus OR country United Kingdom OR country Ireland OR country Norway OR country Finland OR country Denmark OR country Portugal OR country Turkey OR country Lithuania OR country Latvia OR country Estonia OR country Kosovo OR country Montenegro OR country Bosnia and Herzegovina OR country Egypt OR country Syria OR country Libya OR country Algeria OR country Morocco OR country Israel OR country Cyprus OR country Malta)' \


Magnoliopsida : NCBI:txid3398

Acrogymnospermae : NCBI:txid1437180

qiime rescript get-ncbi-data \
    --p-query '(txid1437180[ORGN] AND (ITS OR country Internal Transcribed Spacer) NOT environmental sample[Title] NOT environmental samples[Title] NOT environmental[Title] NOT uncultured[Title] NOT unclassified[Title] NOT unidentified[Title] NOT unverified[Title] AND (country France OR country Spain OR country Germany OR country Italy OR country Belgium OR country Greece OR country Iceland OR country Lebanon OR country Liechtenstein OR country Luxembourg OR country Russia OR country Slovakia OR country Slovenia OR country Sweden OR country Switzerland OR country Turkmenistan OR country Uzbekistan OR country Netherlands OR country Poland OR country Czech republic OR country Austria OR country Croatia OR country Albania OR country Macedonia OR country Serbia OR country Romania OR country Moldavia OR country Ukraine OR country Belarus OR country United Kingdom OR country Ireland OR country Norway OR country Finland OR country Denmark OR country Portugal OR country Turkey OR country Lithuania OR country Latvia OR country Estonia OR country Kosovo OR country Montenegro OR country Bosnia and Herzegovina OR country Egypt OR country Syria OR country Libya OR country Algeria OR country Morocco OR country Israel OR country Cyprus OR country Malta)' \
    --o-sequences taxonomy/RefTaxo.qza \
    --o-taxonomy taxonomy/DataSeq.qza
