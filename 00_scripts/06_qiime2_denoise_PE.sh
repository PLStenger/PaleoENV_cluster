...
OUTPUT=/scratch_vol0/fungi/PaleoENV_cluster/05_QIIME2/visual/trnL

# Make the directory (mkdir) only if not existe already(-p)
mkdir -p $OUTPUT

METADATA=/scratch_vol0/fungi/PaleoENV_cluster/98_database_files/sample-metadata_trnL.tsv
...
METADATA=/scratch_vol0/fungi/PaleoENV_cluster/98_database_files/sample-metadata_ITS2.tsv
# negative control sample :
NEG_CONTROL=/scratch_vol0/fungi/PaleoENV_cluster/99_contamination
